...
public class KugouMusicSource implements MusicSource {
    ...
    public MusicInfo get(String keyword) throws Exception {
        ...
        JSONObject je = JSONUtil
                            .parseObj(new String(Util.readAll(huc.getInputStream()), StandardCharsets.UTF_8).replaceAll("<!--[_A-Z]+-->", ""));
        ...
        ihuc.connect();
        JSONObject info = JSONUtil.parseObj(new String(Util.readAll(ihuc.getInputStream()), StandardCharsets.UTF_8)).getJSONObject("data");
